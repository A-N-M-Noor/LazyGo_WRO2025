...
#define SERVO_PIN 2
#define SERVO_MIN_US 550   // steers robot to the right
#define SERVO_MAX_US 1700  // steers robot to the left
#define SERVO_CENTER_US 1125 // center position for servo (Adjust if needed)
