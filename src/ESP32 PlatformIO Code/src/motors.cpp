...
void Motors::speedControlTask(void *pvParameters)
{
    ...
    const float kp_speed = 0.5;              // Proportional gain for speed control
    ...
    while (true)
    {
        ...
        if (motors->use_position_control && abs(motors->target_position_mm - motors->current_position_mm) > position_tolerance_mm)
        {
            ...
            // Debug output for position mode
            Serial.print("PositionControl: ");
            Serial.print(delta_time_ms);
            Serial.print(" ms since last call, Target pos: ");
            Serial.print(motors->target_position_mm);
            Serial.print(" mm, Current pos: ");
            Serial.print(motors->current_position_mm);
            Serial.print(" mm, Commanded speed: ");
            Serial.print(commanded_speed_mms);
            Serial.print(" mm/s, Actual speed: ");
            Serial.print(actual_speed_mms);
            Serial.print(" mm/s, PWM duty: ");
        ...
        else
        {
            ...
            else
            {
                ...
                // Debug output for speed mode
                Serial.print("SpeedControlTask: ");
                Serial.print(delta_time_ms);
                Serial.print(" ms since last call, Target speed: ");
                Serial.print(motors->target_speed_mms);
                Serial.print(" mm/s, Actual speed: ");
                Serial.print(actual_speed_mms);
                Serial.print(" mm/s, PWM duty: ");
                Serial.println(pwm_duty);
